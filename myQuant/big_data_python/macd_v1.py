...
# zwQuant
from myQuant.big_data_python import zwSys as zw
from myQuant.big_data_python import zwTools as zwt
from myQuant.big_data_python import zwQTBox as zwx
from myQuant.big_data_python import zwQTDraw as zwdr
from myQuant.big_data_python import zwBacktest as zwbt
from myQuant.big_data_python import zwStrategy as zwsta
from myQuant.big_data_python import zw_talib as zwta
...
qx = zwbt.bt_init(xlst, rss, 'macd10', 10000);
#
# ---设置策略参数
qx.staVars = [12, 26, '2015-01-01', '']
qx.debugMod = 1
qx.staFun = zwsta.macd10;  # ---绑定策略函数&运行回溯主函数
